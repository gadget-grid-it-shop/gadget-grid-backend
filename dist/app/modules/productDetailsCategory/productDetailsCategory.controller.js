...
const createProductDetailsCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield productDetailsCategory_service_1.ProductDetailsCategoryServices.createProductDetailsCategoryIntoDB(payload, admin);
...
const updateProductDetailsCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const payload = req.body;
    const { admin } = req.user;
    const result = yield productDetailsCategory_service_1.ProductDetailsCategoryServices.updateProductDetailsCategoryIntoDB(id, payload, admin);
    (0, sendResponse_1.default)(res, {
        data: result,
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteProductDetailsCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const { admin } = req.user;
    const result = yield productDetailsCategory_service_1.ProductDetailsCategoryServices.deleteProductDetailsCategoryFromDB(id, admin);
    (0, sendResponse_1.default)(res, {
        data: result,
        statusCode: http_status_1.default.OK,
        success: true,
