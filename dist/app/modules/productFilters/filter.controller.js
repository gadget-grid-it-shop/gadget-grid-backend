...
const updateFilter = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield filter_service_1.FilterServices.updateFilterIntoDB(payload, id);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
exports.FilterControllers = { createFilter, updateFilter, getAllFilters, deleteFilter };
