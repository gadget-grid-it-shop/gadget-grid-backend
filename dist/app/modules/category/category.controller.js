...
const createCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield category_service_1.CategoryServices.createCategoryIntoDB(req.body, admin);
...
const deleteCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { admin } = req.user;
    const result = yield category_service_1.CategoryServices.deleteCategoryFromDB(req.params.id, admin);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const updateCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { admin } = req.user;
    const result = yield category_service_1.CategoryServices.updateCategoryIntoDB(req.params.id, req.body, admin);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
