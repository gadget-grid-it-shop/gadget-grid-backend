...
router.post('/create-admin', (0, validateRequest_1.validateRequest)(user_validation_1.UserValidations.createUserValidationSchema), (0, validateRequest_1.validateRequest)(admin_validation_1.AdminValidations.CreateAdminValidationSchema), (0, checkPermission_1.default)(roles_interface_1.EAppFeatures.user, 'create'), user_controller_1.UserController.createUser);
