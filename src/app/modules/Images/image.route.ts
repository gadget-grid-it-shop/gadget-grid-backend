...
router.get('/get-all', checkPermission(EAppFeatures.photo, 'read'), ImageUploadController.getAllImages)

router.delete('/delete-images', checkPermission(EAppFeatures.photo, 'delete'), ImageUploadController.deleteImages)
