...
router.get("/single/:id", checkPermission(EAppFeatures.productDetails, 'read'), ProductDetailsCategoryControllers.getSingleProductDetailsCategory);

router.get("/get-all", checkPermission(EAppFeatures.productDetails, 'read'), ProductDetailsCategoryControllers.getAllProductDetailsCategory);

router.delete("/delete/:id", checkPermission(EAppFeatures.productDetails, 'delete'), ProductDetailsCategoryControllers.deleteProductDetailsCategory);
